...
public class QuestionThreeAdapter  extends RecyclerView.Adapter<QuestionThreeAdapter.ViewHolder> {

    private List<LevelThreeService> levelOneServices;
    ...
    public QuestionThreeAdapter(Activity activity, List<LevelThreeService> levelOneServices) {
        context = activity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        final LevelThreeService packageList = levelOneServices.get(position);
