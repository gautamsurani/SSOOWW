...
public class QuestionTwoAdapter extends RecyclerView.Adapter<QuestionTwoAdapter.ViewHolder> {
    ...
    private List<LevelTwoService> levelOneServices;
    ...
    public QuestionTwoAdapter(Activity activity, List<LevelTwoService> levelOneServices) {
        context = activity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        final LevelTwoService packageList = levelOneServices.get(position);
